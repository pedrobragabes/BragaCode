    ...
    <>
      ...
      <article className="section legal-page"><div className="container legal-grid">
        ...
        <div className="legal-content">
          ...
          <section id="compartilhamento"><span>04</span><h2>Fornecedores e compartilhamento</h2><p>Dados podem passar por provedores de hospedagem, envio de e-mail e proteção antispam configurados para operar o site. A BragaCode não vende os dados recebidos. Analytics só é carregado quando configurado e deve ser refletido nesta política antes do lançamento público.</p></section>
